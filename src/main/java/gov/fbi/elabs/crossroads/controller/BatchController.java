...
public class BatchController {
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "employeeId", value = "Provide Employee id whose batches need to be retrieved", dataType = "int", paramType = "query"),
			@ApiImplicitParam(name = "days", value = "No of days before batch expires", dataType = "int", paramType = "query"),
