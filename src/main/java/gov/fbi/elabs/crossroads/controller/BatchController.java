...
public class BatchController {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "Cookie", value = "Cookie Values", paramType = "header", dataType = "string", required = false),
			@ApiImplicitParam(name = "Host", value = "Host", defaultValue="crossservice.us-west-1.elasticbeanstalk.com", paramType = "header", dataType = "string", required = false) })
