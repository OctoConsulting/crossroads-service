...
public class EvidenceTransferRepository extends BaseRepository {
	...
	public String setQueryForEvidenceTransferTable(Integer batchID, String evidenceTransferTypeCode, Integer employeeID,
		...
		sql.append(" ( select  GETDATE(), b.BatchID,b.CreatedDate, " + "\'" + evidenceTransferTypeCode + "\'" + ",'C',"
				+ "null," + employeeID + "," + "e.CustodyLocationID,null,e.CustodyOrganizationID,null," + "null,"
				+ storageAreaID + "," + "\'" + storageLocationID + "\'" + ",null,"
		...
		sql.append(" union ");
		sql.append(" select  GETDATE(), b.BatchID,b.CreatedDate, " + "\'" + evidenceTransferTypeCode + "\'" + ",'C',"
				+ employeeID + "," + "null," + "null," + locationID + "," + "null," + organizationID + "," + "null,"
				+ storageAreaID + "," + "\'" + storageLocationID + "\'" + ",null,"
				+ "e.FSLabNum, e.CurrentSubmissionNum,e.EvidenceType,e.EvidenceID," + "\'" + comments + "\'" + ",null,"
				+ transferReason + "," + "\'" + loggedinUser + "\'" + ", GETDATE()," + "\'" + loggedinUser + "\'"
				+ ", GETDATE(),1," + witness1ID + "," + witness2ID + ",null,null" + " from Batch b"
